    ...
    <div class="header__main">
      ...
      <div class="container">
        ...
        <div class="header__menu">
          ...
          <nav class="nav">
            <ul class="menu">
              <li class="menu__item"><a href="#" class="menu__link">О сервисе</a></li>
              <li class="menu__item has-dropdown">
                <a href="#" class="menu__link">Клиентам</a>
                <ul class="menu-dropdown">
                  <li class="menu-dropdown__item"><a href="#" class="menu-dropdown__link">Как работает сервис</a></li>
                  <li class="menu-dropdown__item"><a href="#" class="menu-dropdown__link">Вопросы и ответы</a></li>
                </ul>
              </li>
              <li class="menu__item"><a href="#" class="menu__link">Пользователям</a></li>
        ...
        <!-- END header__menu -->
<!-- BEGIN header__menu -->
        <div class="header__menu" style="background-color:red">
          <!-- BEGIN menu -->
          <nav class="nav">
            <ul class="menu">
              <li class="menu__item has-dropdown">
                ...
                <ul class="menu-dropdown">
					<li class="menu-dropdown__item"><a href="#" class="menu-dropdown__link">Отчеты</a></li>
					<li class="menu-dropdown__item"><a href="#" class="menu-dropdown__link">Статистика по складым</a></li>
                </ul>			  
			  </li>
			  <li class="menu__item has-dropdown">
                <a href="#" class="menu__link">Добавить</a>
                <ul class="menu-dropdown">
                  <li class="menu-dropdown__item"><a href="#" class="menu-dropdown__link">Пользователя</a></li>
                  <li class="menu-dropdown__item"><a href="#" class="menu-dropdown__link">Склад</a></li>
                  <li class="menu-dropdown__item"><a href="#" class="menu-dropdown__link">Продукцию</a></li>
                  <li class="menu-dropdown__item"><a href="#" class="menu-dropdown__link">Склад-пользователь</a></li>		
                  <li class="menu-dropdown__item"><a href="#" class="menu-dropdown__link">Склад-Продукция</a></li>					  
                </ul>
              </li>
...
<!-- END menu -->
          <a href="#" class="menu-opener2 ssm-toggle-nav">
            <span class="menu-opener__line"></span>
          </a>
        </div>
<!-- END header__menu -->		
