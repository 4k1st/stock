...
<menu type="toolbar" style='toolbar' label="menu">
	<li>
		<menu label="1Добавить">
			<button type="button" onclick="loadStock('stock')">Склад</button><br/>
			<button type="button" onclick="loadStock('user')">Пользователь</button><br/>
			<button type="button" onclick="loadStock('goods')">Продукция</button><br/>
		</menu>
	</li>
	<li>
		<menu label="2Назначить">
			<button type="button" onclick="loadStock('stockUser')">Склад-Пользователь</button><br/>
			<button type="button" onclick="loadStock('stockGood')">Склад-Продукция</button><br/>
		</menu>
    </li>
</menu>	  
